...
class ReclamationController extends AbstractController
{
    ...
    /**
     * @Route("/{id_rec}", name="reclamation_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{id_rec}/edit", name="reclamation_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{id_rec}", name="reclamation_delete", methods={"POST"})
     */
    ...
    public function Tri(Request $request,ReclamationRepository $repository): Response
    {
        ...
        if($order== "Croissant"){
            $reclamationss = $repository->tri_asc();
        }
        else {
    ...
    /**
     * @Route("/recherche", name="reclamation_search", methods={"GET"})
