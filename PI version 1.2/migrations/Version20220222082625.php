 ...
 */
final class Version20220222082625 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE admin ADD id_admin INT AUTO_INCREMENT NOT NULL, ADD roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', DROP id, ADD PRIMARY KEY (id_admin)');
