...
{
    /**
     * @Route("/", name="amande_index", methods={"GET"})
     */
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('amande_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    /**
     * @Route("/{id_amande}", name="amande_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{id_amande}/edit", name="amande_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{id_amande}", name="amande_delete", methods={"POST"})
     */
    public function delete(Request $request, Amande $amande, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$amande->getId_amande(), $request->request->get('_token'))) {
